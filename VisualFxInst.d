// No Magic Glow 1.1 NB Patch https://www.nexusmods.com/gothic2/mods/35
//
// How to ship as .vdf mod:
// Save at _work/Data/Scripts/System/VISUALFX/VisualFxInst.d
// Run GothicStarter_mod.exe with "parse scripts" option checked
// Copy compiled VISUALFX.DAT to work/Data/Scripts/_compiled/VISUALFX.DAT
// Use VDFS (in tools) to build volume
...
{
	visname_s = "MFX_deathbolt_COLLIDE";
	visalpha = 1;
	emtrjmode_s = "FIXED";
	emtrjoriginnode = "BIP01";
};
...
instance SPELLFX_DEATHBALL(CFX_BASE_PROTO)
{
	...
	emactioncollstat_s = "COLLIDE";
	emactioncolldyn_s = "CREATEONCE";
	emfxcolldynperc_s = "spellFX_DEATHBALL_SENDPERCEPTION";
	emtrjtargetrange = 20;
	emtrjtargetelev = 0;
...
instance SPELLFX_DEATHBALL_INVEST(CFX_BASE_PROTO)
{
	visname_s = "MFX_DEATHBALL_INVEST";
	emtrjmode_s = "FIXED";
};

instance SPELLFX_DEATHBALL_SLOWTIME(CFX_BASE_PROTO)
{
	emfxtriggerdelay = 6;
	emfxlifespan = 30;
	visname_s = "morph.fov";
...
instance SPELLFX_DEATHBALL_BLOODFLY(CFX_BASE_PROTO)
{
	visname_s = "MFX_DEATHBALL_FLYTOPLAYER";
	emtrjeasevel = 0.01;
	emtrjmode_s = "TARGET LINE";
	emtrjoriginnode = "Bip01 Spine2";
	emtrjtargetnode = "ZS_RIGHTHAND";
...
instance SPELLFX_DEATHBALL_SENDPERCEPTION(CFX_BASE_PROTO)
{
	visname_s = "MFX_DEATHBALL_TARGET";
	sendassessmagic = 1;
	sfxid = "MFX_SuckEnergy_Target";
};
